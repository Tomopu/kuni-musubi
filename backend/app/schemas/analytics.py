...
ALLOWED_EVENT_TYPES = {"impression", "click", "detail_view", "helpful_click"}
ALLOWED_SURFACES = {"home", "party", "category"}
...
class ArticleEventRequest(BaseModel):
    event_type: Literal["impression", "click", "detail_view", "helpful_click"]
    article_id: UUID
    surface: Literal["home", "party", "category"]
